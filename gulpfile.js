...
gulp.task('template', function () {
  return gulp.src('src/components/**/*.html')
    .pipe($.angularTemplatecache('templates.run.js', {
      templateHeader: `export const TemplateRun = ['$templateCache', '$browser', function($templateCache, $browser) {`,
      templateFooter: `\n$browser.baseHref = $browser.baseHref = function () { return location.pathname; };\n}];`
    }))
